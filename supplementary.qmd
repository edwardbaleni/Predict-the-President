...
# remove numbers
sentences$speech <- gsub('[0-9]+', '', sentences$speech)
# remove contractions
sentences$speech <- gsub("/'s", "", sentences$speech)
# remove special characters
sentences$speech <- gsub("[^[:alnum:] ]", "", sentences$speech)
# lemmatization
sentences$speech <- lemmatize_strings(sentences$speech)
```
