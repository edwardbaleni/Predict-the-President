...
samp <- sample(1:nrow(data_train), size = nrow(data_train)*0.7)
...
library(e1071)
data_classifier <- naiveBayes(data_train[samp,], Data_train$president[samp], laplace = 1)
...
1 - sum(diag(tab1))/sum(tab1)  # When findFreqTerms(x) then this is 0.72
```


```{r}
1 - (202 +140 + 102 + 257 + 137 + 136) / 1200 # Normalization when calculating tfidf (Insample)
1 - (207 + 124 + 98 + 168 + 126 + 130) / 1200 # No normalization when calculating tfidf (Insample)


# No laplace
1 - (15 + 475 + 512 + 14 + 662 + 799) / 4800

# Laplace = 1
1 - (11 + 504 + 539 + 11 + 684 + 881) / 4800

# Laplace = 2
1 - (15 + 486 + 473 + 11 + 662 + 884) / 4800

# Laplace = 3
1 - (15 + 478 + 412 + 10 + 645 + 892) / 4800
