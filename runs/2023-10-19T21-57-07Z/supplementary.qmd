...
Often it would seem that unigrams are sufficient amongst the three. It is however, interesting to observe the behaviour of n-grams <!-- https://shmpublisher.com/index.php/joscex/article/view/4/13
     https://downloads.webis.de/pan/publications/papers/valencia_2019.pdf
     -->
...
save(classifier, file = "supp_cleanedLexical.RData)
