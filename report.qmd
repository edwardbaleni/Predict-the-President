...
knitr::opts_chunk$set(echo = FALSE, fig.align="center", out.width = "65%", fig.pos = "H", message = F)
```

```{r Packages, include=FALSE, warning=FALSE,results='hide'}
require(dplyr)
require(stringr)
require(tidytext)
require(ggplot2)
...
The data used in this study was sourced from \url{https://www.gov.za/state-nation-address}. The 1994 to 2023 SONA speeches are used within this study. The presidents who were present in this time span were FW De Klerk, Nelson Mandela, Thabo Mbeki, Kgalema Motlanthe, Jacob Zuma and Cyril Ramaphosa.
